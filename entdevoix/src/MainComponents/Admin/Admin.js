                    ...
                    <Row>
                        ...
                        <div id="pages" className="col s12">
                            ...
                            <Row node="article" className="white">
                                <form action="#">
                                    <h6>Accueil</h6>
                                    <textarea className="maxw" name="content" id="" cols="30" rows="10">
                                    </textarea>
                            ...
                            <Row node="article" className="white">
                                <form action="#">
                                    <h6>À propos</h6>
                                    <textarea className="maxw" name="content" cols="30" rows="30">
                                    </textarea>
                                    <Row className="center-align">
                                        <Col s={6}>
                                            <button><i className="material-icons">cancel</i></button>
                        ...
                        <div id="links" className="col s12">
                            ...
                            <div className="container">
                                <form action="#">
                                    <textarea className="maxw" name="" id="" cols="30" rows="10">
