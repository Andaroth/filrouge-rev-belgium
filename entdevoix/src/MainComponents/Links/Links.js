...
<div className="Container Form containerAcceuil Entendeurs">
    ...
    <p>Lundi 16 Février 2015 à 17h sur Radio Panik (105.4 FM), l'émission Psylence Radio accueillait le REV-Belgium.

    Aujourd’hui, l’équipe de PsylenceRadio se transforme en vendeurs de REV. Une petite voix me dit que vous pensez que l’orthographe se perd. Détrompez-vous ! Le REV, ce sont les initiales du Réseau des Entendeurs de Voix. Groupe d’entraide mais pas que, c’est aussi un réseau porteur de voix (tiens ! Encore elles ?) afin de faire évoluer les regards sur ces phénomènes souvent stigmatisés ou facteurs d’exclusion.

    "Quelle voix de rev" (Radio Panik ~ Psylence 2015)</p>
    <div>
        <audio ref="audio_tag" src="http://www.rev-belgium.org/downloads/psylence.mp3" controls controls/>
      </div>
    <h4>Articles</h4>
    ...
    <p>Pour lire l'article cliquer <a href="http://www.enmarche.be/preter-l-oreille-a-ses-voix.htm?from=sante">ici</a></p>
    ...
    <p>Pour lire l'article cliquer <a href="http://www.rev-belgium.org/downloads/Intervoices_2015.pdf">ici</a></p>
    ...
    <p>Pour lire l'article cliquer <a href="http://www.rev-belgium.org/downloads/moustique2015.pdf">ici</a></p>
    ...
    <p>Pour lire l'article cliquer <a href="http://www.rev-belgium.org/downloads/athena311.pdf">ici</a></p>
    ...
    <p>Pour lire l'article cliquer <a href="http://www.rev-belgium.org/downloads/voix00.pdf">ici</a> ou voir le site cliquer <a href="http://reflexions.ulg.ac.be/cms/c_390091/fr/des-voix-dans-la-tete">ici</a></p>
    <h4>Liens</h4>  
    <ul>
  ...
  <li><a href="https://www.facebook.com/Hearing.Voices.USA">Page Facebook de Hearing Voice USA</a></li>
