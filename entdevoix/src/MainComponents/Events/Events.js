            ...
            <div className="event">
                <div className="Container Form containerAcceuil">
                    ...
                    <section id="Event1">
                        ...
                        <p>Le Congrès mondial sur l’entente de voix est organisé chaque année depuis 2009 conjointement
                            par
                            ...
                            personnes de tous horizons et convictions autour d’une perspective commune : Changer
                            l’Histoire
                            en retissant nos histoires !</p>
                        <img id="imgEvent1" alt="Affiche evenement" src="http://www.jim.fr/e-docs/00/02/6B/23/carac_photo_1.jpg"/>
                    </section>
                    <section id="Event2">
                        ...
                        <p>Entendre des voix Etats-Unis est fier de présenter le 9e Congrès mondial Hearing Voices : Une
                            révolution de Unseen voix. Le Congrès aura lieu du 16 au 18 Août 2017 à l' Université de
                            Boston
                            à Boston, Massachusetts, États-Unis.<br/>
                            Plus d'infos sur leur site</p>
                        <img id="imgEvent2" alt="Affiche evenement" src={Oreille}/>
                    </section>
                    <section id="Event3">
                        <h5>J’entends des voix !</h5>
                        <p>Le Réseau « Entendre-des-Voix » REV-Belgium vous invite à venir partager vos interrogations
                            et
                            témoignages autour d’une expérience encore taboue et méconnue, l’entente de voix.</p>
                    </section>
                    <section id="Event4">
                        <h5>Pourquoi une conférence-partage?</h5>
                        <p>Au-delà des groupes d’entraide, le REV-Belgium considère qu’il est important de faire évoluer
                            le
                        ...
                        <ul className="accUl">
                            ...
                            <li className="accLi">êtes-vous tout simplement curieux d’en savoir plus sur ces phénomènes
                                et
